...
/**
 * A helper class for {@link androidx.paging.PagedList.BoundaryCallback NetworkListResourceBoundaryCallback}s and
 ...
 * <pre>
 * class PagingBoundaryCallback extends PagedList.NetworkListResourceBoundaryCallback&lt;MyItem> {
 ...
 *                         new CachedBasicListCallback&lt;ApiResponse>() {
 *                             {@literal @}Override
...
public class PagingRequestHelper {
    ...
    public enum RequestType {
         ...
         * a {@link androidx.paging.PagedList.BoundaryCallback NetworkListResourceBoundaryCallback}.
         */
        INITIAL,
        /**
         * Corresponds to the {@code loadBefore} calls in {@link androidx.paging.DataSource} or
         * {@code onItemAtFrontLoaded} in
         * {@link androidx.paging.PagedList.BoundaryCallback NetworkListResourceBoundaryCallback}.
         */
        BEFORE,
        /**
    ...
    public interface Request {
        ...
        /**
         * CachedBasicListCallback class provided to the {@link #run(Callback)} method to report the result.
         */
        class Callback {
    ...
    /**
     * FirebasePagedListMemoryResource interface to get notified by request status changes.
     */
